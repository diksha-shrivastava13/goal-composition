def setup_arguments():
    ...
    parser.add_argument("--randomise_n_walls", action=argparse.BooleanOptionalAction, default=False)
    ...
    parser.add_argument("--tau_buffer_size", type=int, default=2)
    # --------- EVAL ---------
    ...
    parser.add_argument("--prioritization", type=str, default="rank", choices=["rank", "top_k"])
