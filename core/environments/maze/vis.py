...
def _make_tile_atlas(tile_size):
    ...
    atlas[1] = np.tile([100, 100, 100], (tile_size, tile_size, 1))  # empty
    atlas[3] = np.tile([0, 255, 0], (tile_size, tile_size, 1))  # goal
...
class MazeVisualiser(object):
    ...
    def get_frame(self, env_state, env_params, ignore_view=False):
        ...
        if hasattr(env_state, "is_goal_hidden") and env_state.is_goal_hidden:
